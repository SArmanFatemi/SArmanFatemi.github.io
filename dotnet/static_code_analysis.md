...
tags:
  ...
  - editorconfig
---
`Dicertoy.Build.props` is a `xml` file that allow us to configure shared items between all projects across your solution:
...
And by using `.editorconfig` file, you can configure code style rule for all the files in solution:
```.editorconfig
root = true  
